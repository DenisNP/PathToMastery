...
namespace PathToMastery.Services
{
    public class PathService
    {
        ...
        public State LoadUser(string userId)
        {
            var user = _dbService.ById<User>(userId, false);
            return LoadUser(user);
        }

        private State LoadUser(User user)
        {
            return new State
            {
                User = user,
                First = GenerateCalendar(user.First),
                Second = GenerateCalendar(user.Second),
                Third = GenerateCalendar(user.Third)
            };
        }

        public State CreateEditPath(string userId, int id, string name, string icon, int color, int[] days)
        {
            var user = _dbService.ById<User>(userId, false);
        ...
        public State DeletePath(string userId, int id)
        {
            var user = _dbService.ById<User>(userId, false);
        ...
        private Path GenerateCalendar(PathData data)
        {
            throw new NotImplementedException();
        }
